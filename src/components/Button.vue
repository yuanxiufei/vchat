<!-- 通用按钮组件：支持颜色/尺寸/朴素样式、禁用与加载图标 -->
<template>
  <button
    class="vk-button
    shadow-sm inline-flex items-center justify-center whitespace-nowrap overflow-hidden text-ellipsis
...
// 说明：根据 props 组合样式类；loading 时替换为旋转图标
